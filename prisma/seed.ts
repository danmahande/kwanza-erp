...
async function main() {
  ...
  // Create Outbound Records — matching real format: 18 columns
  const outboundRecords = [
    { outboundId: 'OB0000001', orderNumber: 'ORD-20260413-0001', userId: 'U003', trackingNumber: 'TRK-20260413-0001', vendorId: 'V001', businessName: 'Supreme Office Supplies Ltd', customerName: 'Jane Wanjiku', customerContact: '+254722001001', customerEmail: 'jane@email.com', customerAddress: 'Nairobi, Kilimani, Galana Rd', productName: 'Supreme office pens BLUE-50PCs', productId: 'P0001', brand: 'Supreme', variant: 'BLUE-50PCs', qty: 10, unitSellingPrice: 500, saleAmount: 5000, assignedBy: 'admin@kwanza.com', assignedDriver: 'James Mwangi', vehicleNumber: 'KBA 234J', runsheetId: 'RS-20260413-001', stopSequence: 1, actualDeliveredQty: 10, codCollected: 5000, status: 'delivered', dispatchedAt: new Date('2026-04-13T08:00:00'), deliveredAt: new Date('2026-04-13T09:15:00') },
    { outboundId: 'OB0000002', orderNumber: 'ORD-20260413-0002', userId: 'U003', trackingNumber: 'TRK-20260413-0002', vendorId: 'V004', businessName: 'Beverage Central Ltd', customerName: 'John Otieno', customerContact: '+254722001002', customerEmail: 'john@email.com', customerAddress: 'Nairobi, Westlands, Waiyaki Way', productName: 'Coca-Cola 500ml PET-500ML', productId: 'P0008', brand: 'Coca-Cola', variant: 'PET-500ML', qty: 24, unitSellingPrice: 65, saleAmount: 1560, assignedBy: 'admin@kwanza.com', assignedDriver: 'James Mwangi', vehicleNumber: 'KBA 234J', runsheetId: 'RS-20260413-001', stopSequence: 2, actualDeliveredQty: 24, codCollected: 1560, status: 'delivered', dispatchedAt: new Date('2026-04-13T08:00:00'), deliveredAt: new Date('2026-04-13T09:45:00') },
    { outboundId: 'OB0000003', orderNumber: 'ORD-20260413-0003', userId: 'U004', trackingNumber: 'TRK-20260413-0003', vendorId: 'V006', businessName: 'Kwanza Household Goods', customerName: 'Peter Kamau', customerContact: '+254722001004', customerAddress: 'Nakuru, CBD, Kenyatta Ave', productName: 'Detergent Powder 1KG-LEMON', productId: 'P0012', brand: 'Kwanza', variant: '1KG-LEMON', qty: 5, unitSellingPrice: 280, saleAmount: 1400, assignedBy: 'warehouse@kwanza.com', assignedDriver: 'James Mwangi', vehicleNumber: 'KBA 234J', runsheetId: 'RS-20260413-001', stopSequence: 3, actualDeliveredQty: 4, codCollected: 1120, deliveryNotes: 'Customer rejected 1 unit - damaged packaging', status: 'delivered', dispatchedAt: new Date('2026-04-13T08:00:00'), deliveredAt: new Date('2026-04-13T11:30:00') },
    { outboundId: 'OB0000004', orderNumber: 'ORD-20260414-0001', userId: 'U003', trackingNumber: 'TRK-20260414-0001', vendorId: 'V010', businessName: 'Kenya Bakeries Ltd', customerName: 'Mary Akinyi', customerContact: '+254722001003', customerEmail: 'mary@email.com', customerAddress: 'Mombasa, Nyali, Links Rd', productName: 'White Bread 400G-1PK', productId: 'P0016', brand: 'Kenya Bakeries', variant: '400G-1PK', qty: 20, unitSellingPrice: 50, saleAmount: 1000, assignedBy: 'admin@kwanza.com', assignedDriver: 'Samuel Kiprop', vehicleNumber: 'KCC 567K', runsheetId: 'RS-20260414-001', stopSequence: 1, actualDeliveredQty: 20, codCollected: 1000, status: 'delivered', dispatchedAt: new Date('2026-04-14T07:30:00'), deliveredAt: new Date('2026-04-14T10:00:00') },
    { outboundId: 'OB0000005', orderNumber: 'ORD-20260414-0002', userId: 'U004', trackingNumber: 'TRK-20260414-0002', vendorId: 'V005', businessName: 'Fresh Dairy Farmers Coop', customerName: 'Grace Chebet', customerContact: '+254722001005', customerEmail: 'grace@email.com', customerAddress: 'Kisumu, Milimani, Oginga Odinga Rd', productName: 'Fresh Milk 500ml 500ML-1PK', productId: 'P0010', brand: 'Fresh Dairy', variant: '500ML-1PK', qty: 15, unitSellingPrice: 80, saleAmount: 1200, assignedBy: 'warehouse@kwanza.com', assignedDriver: 'Samuel Kiprop', vehicleNumber: 'KCC 567K', runsheetId: 'RS-20260414-001', stopSequence: 2, status: 'dispatched', dispatchedAt: new Date('2026-04-14T07:30:00') },
