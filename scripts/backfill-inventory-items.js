 ...
 *
 * Usage (plain Node, no ts-node needed):
 *   node scripts/backfill-inventory-items.js
 */
...
async function main() {
  ...
  for (const inbound of inbounds) {
    ...
    console.log(`    Done: created ${qty} items`)
  }

  console.log(`\nComplete! Created ${totalCreated} InventoryItems. Skipped ${skipped} inbound records.`)
}
