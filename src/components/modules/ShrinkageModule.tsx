...
import { AlertTriangle, Package, Clock, CheckCircle2, TrendingDown, UserCircle, AlertOctagon, ChevronDown, ChevronRight, Plus, ArrowLeft as BackIcon } from 'lucide-react'
